...
int main()
{
    ...
    auto v5 = CreateVector<int>(10, [](const size_t i) { return i / 3; });
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    auto remove_multiples = [](std::vector<int>& v) { // Zadanie 5
    ...
    auto remove_negatives = [](std::vector<int>& v) { // Zadanie 6
    ...
    override_elements(fibo, 17, 3);
    std::cout << "After overriding elements: " << fibo << std::endl;
